  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore ClinoPilot&apos;s premium retainer plan – full-service clinical systems support for $1500 USD/month. Designed for clinics and private practices seeking ongoing digital strategy and optimization." />
      </Head>
